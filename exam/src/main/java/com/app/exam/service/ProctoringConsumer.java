...
public class ProctoringConsumer {
    ...
    @KafkaListener(topics = "proctoring-events", groupId = "proctoring-group", containerFactory = "genericListenerFactory")
    public void consumeProctoringEvent(Map<String, Object> event, Acknowledgment ack) {
